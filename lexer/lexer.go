...
//checks the character ahead and increaments
...
func (l *Lexer) NextToken() token.Token {
	...
	case '!':
		if l.peekChar() == '=' {
			ch := l.ch //prevent loosing current char
			l.readChar()
...
//same as readChar but l.positon and l.readPostion doesn't increament. Takes a look at the character ahead.
...
//LEXER's work is to turn input to tokens.